...
public class Main {
    public static void main(String[] args) {
        ...
        shoppingCart.addProduct(new Product("tshirt", new BigDecimal("12.50")));
        shoppingCart.addProduct(new Product("pants", new BigDecimal("20.90")));
        shoppingCart.addProduct(new Product("shoes", new BigDecimal("18.70")));
