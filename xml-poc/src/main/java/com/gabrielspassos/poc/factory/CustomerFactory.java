...
public class CustomerFactory {
    ...
    public static Customer createNaturalCustomer() {
        ...
        return createCustomer(1, "Jose Silva Souza", "27670104015", PersonType.NATURAL,
                "jose.souza@gmail.com", Boolean.TRUE, accounts);
    }

    public static Customer createLegalCustomer() {
        List<Account> accounts = List.of(AccountFactory.createPagamentoAccount());
        return createCustomer(2, "Empresa A Ltda", "24496061000150", PersonType.LEGAL,
                "empresa@gmail.com", Boolean.FALSE, accounts);
    }

    private static Customer createCustomer(Integer id, String name, String document, PersonType type,
